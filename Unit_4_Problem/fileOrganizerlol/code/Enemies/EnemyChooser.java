...
public class EnemyChooser {
    ...
    public EnemyBuild chosenEnemy(player player) {
        ...
        randEnemy.add(new Slime("Slime", rand.nextInt(5*(int)(player.getLevel()*1.625))+1, rand.nextInt(5*(int)(player.getLevel()*1.625))+1, rand.nextInt(5*(int)(player.getLevel()*1.625))));
